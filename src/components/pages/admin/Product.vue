	...
	<!-- Add Model -->
      ...
      <modal modalHeading="Add New product" :cond="showingAddModal" @modalClose="showingAddModal = false">
          <table >
            <tr>
              <td>Product Name</td>
              <td><input type="text" id="newcatname" v-model="newproduct.name"  placeholder="Product Name"></td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <select v-model="newproduct.category">
                  ...
                  <option v-for="c in allcategories" :value="c.id">
                    {{ c.cname }}
                  </option>
                </select>
              </td>
            ...
            <tr>
              ...
              <td>
                <select v-model="newproduct.supplier">
                  ...
                  <option v-for="s in allsuppliers" :value="s.id">
                    {{ s.sname }}
                  </option>
                </select>
              </td>
            ...
            <tr>
              <td>Price</td>
              <td><input type="number"  v-model="newproduct.price"  placeholder="Product Price">
            ...
            <tr>
              <td>Image</td>
              <td><input type="file" id="image" @change="onfilechange" ></td>
            </tr>

            <tr>
              <td></td>
              <td>
                <progress :value="percent" max="100" v-if="percent != 0 && percent != 100 "></progress> <span v-if="percent != 0 && percent != 100 "> {{ percent }} %</span> <br><br>
                <img :src="'http://localhost/ecommerce_vue/src' + newproduct.image" alt="No image selected" width="150">
              </td>
            </tr>
            ...
            <tr>
              <td>Description</td>
              <td>
                <textarea rows="4" type="text" id="newcatname"  v-model="newproduct.description" placeholder="Write a short Description">
      ...
      <!-- Edit Model -->
       ...
       <modal modalHeading="Update This product" :cond="showingEditModal" @modalClose="showingEditModal = false">
         <table >
            <tr>
              <td>Product Name</td>
              <td><input type="text"  v-model="clickedProduct.pname"  placeholder="Product Name"></td>
            </tr>
            ...
            <tr>
              <td>Price</td>
              <td><input type="number"  v-model="clickedProduct.price"  placeholder="Product Price">
               <label><input type="checkbox" v-model= "newproduct.negotiable"> Negotiable</label> 
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <progress :value="percent" max="100" v-if="percent != 0 && percent != 100 "></progress> <span v-if="percent != 0 && percent != 100 "> {{ percent }} %</span> <br><br>
                <img :src="'http://localhost/ecommerce_vue/src' + clickedProduct.image" alt="No image selected" width="150">
              </td>
            </tr>
            ...
            <tr>
              <td>Description</td>
              <td>
                <textarea rows="4" type="text" id="newcatname"  v-model="clickedProduct.description" placeholder="Write a short Description">
      ...
      <modal modalHeading="Delete This Product" :cond="showingDeleteModal" @modalClose="showingDeleteModal = false">
          <table >
        
          <tr>
              <td><h3>Are You sure to Delete this product "{{ clickedProduct.pname }}" ?</h3></td>
	...
	<h2 class="fleft ">product</h2>
      ...
      <table class="nice-table" >
          ...
          <tr v-for="(product, i) in products">
            <td> {{ i+1 }} </td>
            <td> <img :src="'http://localhost/ecommerce_vue/src' + product.image" width="80" height="100"> </td>
            <td> {{ product.pname }} </td>
            <td> {{ product.cname }}</td>
            <td> {{ product.sname }}</td>
...
export default {
  ...
  methods: {
    ...
    onfilechange(e){
        ...
        this.$axios.post("http://localhost/ecommerce_vue/src/api/upload.php", fd, {
    ...
    addNewproduct(){
        ...
        //console.log(this.newproduct);
      	...
      	this.$axios.post("http://localhost/ecommerce_vue/src/api/product_api.php?action=create", formData)
      		.then(res=>{
      ...
      updateproduct(){
      		...
      		this.$axios.post("http://localhost/ecommerce_vue/src/api/product_api.php?action=update", formData)
      		.then(res=>{
      ...
      deleteProduct(){
      	...
      	//this.$eventBus.$emit("loadingStatus", true);
      	var formData = this.toFormData(this.clickedProduct);
      	this.$axios.post("http://localhost/ecommerce_vue/src/api/product_api.php?action=delete", formData)
      	.then(res=>{
